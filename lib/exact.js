 ...
 * done: renamed unstable_renderSubtreeIntoContainer to renderSubtreeIntoContainer
 */
...
// *********************************************************************************************************
	...
	function renderSubtreeIntoContainer(parentComponent, subVnode, container, callback) {
		let context = parentComponent.$cache.parentContext
		return renderTreeIntoContainer(subVnode, container, callback, context)
	}
	ReactDOM.renderSubtreeIntoContainer = renderSubtreeIntoContainer;
...
// *********************************************************************************************************
	...
	function loadScript( url, onLoad, onError, scope, charset ) {
