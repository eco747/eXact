...
/**
 * assertion
 * @param {Boolean} expr - expression to check, if false throw an error
...
/**
 * logging, log a message in the console
 */
 ...
 * @param  {Number} v    value tou round
...
/**
 * check is an element is a descendant of another element
 */

function isDescendantElement( el, root ) {
